<h2><a href="https://leetcode.com/problems/random-pick-with-blacklist/?envType=problem-list-v2&envId=math">710. Random Pick with Blacklist</a></h2><h3>Hard</h3><hr><p>You are given an integer <code>n</code> and an array of <strong>unique</strong> integers <code>blacklist</code>. Design an algorithm to pick a random integer in the range <code>[0, n - 1]</code> that is <strong>not</strong> in <code>blacklist</code>. Any integer that is in the mentioned range and not in <code>blacklist</code> should be <strong>equally likely</strong> to be returned.</p>
