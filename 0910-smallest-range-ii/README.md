<h2><a href="https://leetcode.com/problems/smallest-range-ii/?envType=problem-list-v2&envId=math">910. Smallest Range II</a></h2><h3>Medium</h3><hr><p>You are given an integer array <code>nums</code> and an integer <code>k</code>.</p>
