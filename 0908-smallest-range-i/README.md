<h2><a href="https://leetcode.com/problems/smallest-range-i/?envType=problem-list-v2&envId=math">908. Smallest Range I</a></h2><h3>Easy</h3><hr><p>You are given an integer array <code>nums</code> and an integer <code>k</code>.</p>
