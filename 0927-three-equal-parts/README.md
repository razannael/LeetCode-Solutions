<h2><a href="https://leetcode.com/problems/three-equal-parts/?envType=problem-list-v2&envId=math">927. Three Equal Parts</a></h2><h3>Hard</h3><hr><p>You are given an array <code>arr</code> which consists of only zeros and ones, divide the array into <strong>three non-empty parts</strong> such that all of these parts represent the same binary value.</p>
