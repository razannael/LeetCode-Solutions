<h2><a href="https://leetcode.com/problems/minimum-area-rectangle/?envType=problem-list-v2&envId=math">939. Minimum Area Rectangle</a></h2><h3>Medium</h3><hr><p>You are given an array of points in the <strong>X-Y</strong> plane <code>points</code> where <code>points[i] = [x<sub>i</sub>, y<sub>i</sub>]</code>.</p>
